sap.ui.define(["sap/ui/demo/mdskeleton/view/BaseController"], function (BaseController) {
	...
	onInit : function() {
		...
		if(sap.ui.Device.system.phone) {
			...
			this.getEventBus().subscribe("Master", "ItemSelectedOnMaster", this.onMasterLoaded, this);
		}
	...
	onMasterLoaded :  function (sChannel, sEvent, oData) {
		...
		//var sObjectPath = "/Objects('" + oData.bindingContext + "')";
		this.bindView(oData.bindingPath);
		// this.bindView(oData.bindingContext.getPath());
	},
	...
	bindView : function (sObjectPath) {
		...
		if(!oView.getModel().getData(sObjectPath)) {
			...
			oView.getElementBinding().attachEventOnce("dataReceived", function(oEvent) {
